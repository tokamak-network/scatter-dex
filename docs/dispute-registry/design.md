...
> - [../design-shared-orderbook.md](../design-shared-orderbook.md) — current Trade Offer (legacy)
> - [../relayer-security.md](../relayer-security.md) — operational threat model
> - [../PAPER.md](../PAPER.md) §Compliance — dual-CA identity model that makes reputation enforceable
...
- [../PAPER.md](../PAPER.md) §Compliance — dual-CA identity model
- [../architecture-v2.md](../architecture-v2.md) — overall architecture entry point

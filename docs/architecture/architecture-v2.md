...
2. **[relayer-protocol/design.md](../design/relayer-protocol/design.md)** — replace HTTP Trade Offer with a Waku v2-based gossip + commit-reveal protocol modeled after the Steam trading bot ecosystem. Relayers communicate directly with each other.

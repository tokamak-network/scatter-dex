  ...
  return (
    <SafeAreaView style={s.safe} edges={['top']}>
      <View style={s.container}>
        ...
        {/* Fixed Bottom Action — at the viewport bottom so it's always
            reachable. The scrollContent has large `paddingBottom` so
            the last status card can still be scrolled above this button
            instead of being masked behind it. */}
        {tabMode === 'new' && (

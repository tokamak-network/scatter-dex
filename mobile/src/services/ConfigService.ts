...
// which `scripts/dev-fork.sh` regenerates after each deploy — that way the
// mobile client sees the same addresses the frontend does without having
// to inject environment variables into the Expo build.
//

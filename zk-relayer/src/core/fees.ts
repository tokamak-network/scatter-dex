 ...
 * fee-semantics redesign: each side's `maxFee` caps the fee charged
 * against that side's own buyAmount. The caller's relayer may undercut
 * the user's signed `maxFee`; this picks the min.
 *

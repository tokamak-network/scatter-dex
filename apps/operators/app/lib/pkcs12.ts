 ...
 *
 * Byte-for-byte port of the admin console's `apps/admin/app/lib/pkcs12.ts` so a
 * `.p12` produced by either surface decrypts identically. Keep the PBES2
 * parameters in sync if either side changes. (Consolidating both into a shared

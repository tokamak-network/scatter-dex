...
const BRAND_DEFAULT_HEIGHT = 38; // matches the Nextra navbar row
...
function BrandImpl({ height = BRAND_DEFAULT_HEIGHT }: { height?: number }) {
  ...
  return (
    <span className="zs-brand">
      ...
      <span className="zs-brand-text">Scatter Docs</span>
    </span>
  );
}

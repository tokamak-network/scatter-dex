...
export const CATEGORIES: readonly Category[] = [
  ...
  },
  {
    ...
    body: "One-off bonus rounds where no one should be able to tell who got the bigger bonus.",
  ...
  },
  {
    ...
    body: "Settle a wave of contractors at once without revealing which contractor is on which rate.",

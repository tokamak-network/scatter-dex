...
export const CATEGORIES: readonly Category[] = [
  ...
  },
  {
    ...
    body: "One-off bonus rounds where the bigger bonus can't be tied to a name on-chain.",
  ...
  },
  {
    ...
    body: "Settle a wave of contractors at once without tying any rate to a contractor's identity.",

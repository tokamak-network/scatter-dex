/* Scatter Pay brandmark.
 *
 * Composite of the Tokamak Network symbol with a centred italic-serif
 * "zk" overlay, followed by the "Scatter Pay" wordmark. Mirrors the
 * docs / hub / pro brandmarks for cross-app consistency, rendered in
 * Pay's primary accent (--color-primary) via currentColor so the same
 * SVG paths can be reused per-app.
 *
...
/* Two click targets: symbol → cross-app hub, wordmark → Pay home.
 * Lets users navigate to the hub from any deep-linked Pay page

    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="mt-1 max-w-2xl text-sm text-[var(--color-text-muted)]">
          ...
          . Paste the ephemeral pubkey from the sender; the derivation runs
          locally and produces the spending key for that one-time address.
        </p>
      </header>
  ...
  return (
    <section className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-6">
      ...
      <p className="mt-1 text-xs text-[var(--color-text-muted)]">
        Paste the ephemeral pubkey the sender shared. Derivation happens
        entirely in this tab; nothing leaves your browser.
      </p>

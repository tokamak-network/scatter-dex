...
function defaultBody(state: IdentityState): string {
  switch (state.kind) {
    ...
    case "unverified":
      return "Scatter Pro requires a one-time zk-X509 verification before trading or claiming. Submit your certificate on the zk-X509 dashboard to register your wallet.";
    case "error":

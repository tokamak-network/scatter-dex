...
// Block-explorer base URLs by chain id. Chains zkScatter actually deploys
// to only; unknown chains fall through to plain text at UI call sites
// (silently pointing at the wrong explorer is worse than no link).

...
보안 감사에서 발견된 이슈 목록. 각 이슈는 별도 브랜치에서 작업.

## 작업 완료

### H-1. Fee-on-transfer / Rebasing 토큰 회계 불일치
- **브랜치**: `optimize/gas-settlement` (토큰 화이트리스트로 해결)
...
- **브랜치**: `fix/security-h2-relayer-exit-update`
...
### M-1. Owner 단일 실패점 — 2단계 이전 없음
- **브랜치**: `fix/security-m1-ownable2step`

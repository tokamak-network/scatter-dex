...
`ethers@^6` is a peer dependency — install it yourself if your app does
not already depend on it.

`react@^19` is an **optional** peer; only required if you import from
`@zkscatter/sdk/react`.
...
| `@zkscatter/sdk/util` | universal | HTTP / IndexedDB primitives |
